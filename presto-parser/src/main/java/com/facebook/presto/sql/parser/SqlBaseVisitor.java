...
public interface SqlBaseVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by the {@code createTableWithFiber}
	 * labeled alternative in {@link SqlBaseParser#statement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	 ...
	 * @return the visitor result
	 */
	T visitLoadWithDelimited(SqlBaseParser.LoadWithDelimitedContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link SqlBaseParser#hdfsPath}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitHdfsPath(SqlBaseParser.HdfsPathContext ctx);
}